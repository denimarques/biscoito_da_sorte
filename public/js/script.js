...
const sentense = document.querySelector("#sentense");
const buttonOpen = document.querySelector("#open");
const buttonNewSentense = document.querySelector("#new-sentence");


buttonOpen.addEventListener("click", (e) => {
    e.preventDefault();
    const rndInt = randomIntFromInterval(0, 29);
    sentense.innerText = bdSentense[rndInt];
    visibleBox();

});

buttonNewSentense.addEventListener("click", (e) => {
    e.preventDefault();
    visibleBox();
});
...
function visibleBox(){
    faceONe.classList.toggle("hidden");
    faceTwo.classList.toggle("hidden");
}